...
import com.example.reservarestaurantes.databinding.FragmentListaRefeicaoBinding


class ListaRefeicaoFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {

    var refeicaoSelecionada : Refeicao? = null
        get() = field
    set(value) {
        if(value != field){
            field = value
    ...
    private var _binding: FragmentListaRefeicaoBinding? = null
   // private var adapterRefeicao: AdapterRefeicao? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaRefeicaoBinding.inflate(inflater, container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LoaderManager.getInstance(this).initLoader(ListaClientesFragment.ID_LOADER_CLIENTES, null, this)

        //adapterRefeicao = AdapterClientes(this)
        //binding.recyclerViewRefeicao.adapter = adapterRefeicao
        binding.recyclerViewRefeicao.layoutManager = LinearLayoutManager(requireContext())
