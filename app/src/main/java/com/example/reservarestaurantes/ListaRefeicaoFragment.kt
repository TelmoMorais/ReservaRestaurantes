...
class ListaRefeicaoFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterRefeicoes: AdapterRefeicoes?= null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterRefeicoes = AdapterRefeicoes(this)
        binding.recyclerViewRefeicao.adapter = adapterRefeicoes
