...
class TabelaBDReservas (val db: SQLiteDatabase) {
    fun cria(){
        db.execSQL("CREATE TABLE $NOMETABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_DATARESERVA DATE NOT NULL, $CAMPO_TIPOREFEICAO TEXT NOT NULL, " +
